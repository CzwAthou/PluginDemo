package com.athou.plugin.translate.utils;
...
public class PropertiesUtil {
    ...
    private static final String PROPERYIES_NAME_LIST = "varnamesettings_list_b";
    ...
    public static String[] getDefaultProperties() {
        return new String[]{"hello", "mHello", "mHelloStr", "mHelloTv", "mHelloEt", "mHelloBtn", "mHelloView", "mHelloIv", "mHelloLv", "mHelloAdapter", "mHelloRcyview", "mHelloFragment", "mHelloActivity"};
    }
